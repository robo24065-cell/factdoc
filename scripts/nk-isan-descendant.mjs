...
const GAPS = [
  ...
  },
  {
    ...
    gapPp: 13.1,
    reading: '당위와 행동 사이가 13.1%p 비어 있습니다.',
  },
  {
    id: 'want-vs-expect',
...
const out = {
  ...
  gaps: GAPS, scale,
  caveats: [
    '후손 관련 문항은 후손 본인이 아니라 자손이 있는 1세대 4,042명이 자기 자손을 평가한 값입니다. 후손 본인 조사는 아직 없습니다.',
    '요약자료가 이미지 형태여서 이 수치는 사람이 판독해 옮긴 값입니다.',
    '유전자검사 누적 인원은 언론 보도 기준입니다.',
  ],
}
