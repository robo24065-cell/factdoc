...
export const FOOD_KB_EXT: FoodEntry[] = [
  ...
  { name: "우유", aka: ["milk", "흰우유", "생우유", "저지방우유", "무지방우유"], components: ["칼슘", "단백질(카제인·유청)", "비타민B2", "비타민D", "유당(락토오스)", "IGF-1"], effects: [
    { condition: "뼈건강", effect: "칼슘이 풍부해 뼈 건강·골다공증 예방과 관련해 연구된 바 있어요(공식 효능 인정은 아님).", level: "research" },
    { condition: "여드름·피부", effect: "우유(특히 탈지·저지방 우유)와 여드름 악화의 연관성이 여러 역학연구에서 보고됐어요. 우유의 IGF-1·유청단백이 인슐린/IGF-1을 자극해 피지 분비를 늘릴 수 있다는 가설이며, 인과가 확정된 건 아니고 개인차가 큽니다. 트러블이 늘었다면 2~3주 줄여보고 변화를 관찰해 보세요.", level: "caution" },
