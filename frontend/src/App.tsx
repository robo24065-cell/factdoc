    ...
    <div className="min-h-screen bg-white text-slate-700 dark:bg-slate-950 dark:text-slate-300">
      <header className="border-b border-slate-200 dark:border-slate-800">
        <div className="mx-auto max-w-3xl px-4 py-5">
          <h1 className="text-2xl font-medium text-slate-900 dark:text-white">FactDoc</h1>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        <label htmlFor="claim" className="block text-sm font-medium text-slate-700 dark:text-slate-300">
          검증할 건강 주장을 입력하세요
        </label>
        <textarea
          id="claim"
