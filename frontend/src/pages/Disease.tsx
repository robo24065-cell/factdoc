...
export default function Disease() {
  ...
  return (
    <div>
      ...
      <div className="lg:mt-4 lg:grid lg:grid-cols-[minmax(0,1fr)_21rem] lg:items-start lg:gap-8 xl:grid-cols-[minmax(0,1fr)_23rem]">
        {/* 좌측 — 질병청 공식 정보 본문 */}
        <div className="min-w-0">
          <h2 className="mt-5 text-sm font-medium text-slate-700 dark:text-slate-200 lg:mt-0">📘 질병청 공식 정보</h2>
          {sections === null ? (
